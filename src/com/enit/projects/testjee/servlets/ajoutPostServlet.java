...
public class ajoutPostServlet extends HttpServlet {
   ...
   String contenuPost= request.getParameter("contenuPost");
   String lienPost = request.getParameter("lienPost");
   int ident =Integer.parseInt(request.getParameter("idPost")) ;
   Post post1=new Post(ident,contenuPost,lienPost);
